...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <Link
      ...
      className="group block rounded-xl border border-white/[0.08] bg-white/[0.03] p-4 hover:border-indigo-500/40 hover:bg-white/[0.05] transition-all duration-200"
    >
